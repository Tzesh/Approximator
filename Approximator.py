...
lagrange = Interpolation.Lagrange(x.copy(), y.copy())  # creating the lagrange interpolation class
...
nddp = Interpolation.NDDP(x.copy(),
                          y.copy())  # creating the Newton's divided differences polynomial interpolation class
...
directMethod = Interpolation.DirectMethod(x.copy(),
                                          y.copy())  # creating the direct method of polynomial interpolation class
